...
public class Class_01 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			WebElement Search = waitsea.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder = 'Search for anything']")));
			...
			WebElement searchbtn = waitseb.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value = 'Search']")));
